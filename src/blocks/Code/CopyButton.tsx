...
//   return (
//     <div
//       className={`w-full text-emerald-50/75 flex ${filename ? 'justify-between' : 'justify-end'} font-sans items-center flex-wrap py-2`}
//     >
...
//         disabled={copied}
//       >
//         <div className={`flex gap-2 items-center ${!copied ? 'opacity-100' : 'opacity-50'}`}>
