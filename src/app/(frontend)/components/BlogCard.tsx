...
const BlogCard = ({ post }: { post: BlogPost }) => {
  return (
    <Link href={`/blog/${post.slug}`} className="block w-full md:hover:scale-[1.1] transition">
      <div className="bg-[#1b1c21] md:min-h-[250px] h-auto p-5 sm:p-8 md:group-hover:opacity-100 rounded-md overflow-hidden">
        ...
        <p className="text-[#777778] text-[11px] sm:text-[12px] font-light my-4 break-words">{post.postDescription}</p>
