      ...
      <div className="h-[600px] flex gap-5">
        <div className="bg-[#1b1c21] w-[20%] rounded-md pt-5 text-center">
          ...
          <ul className="h-[90%] flex flex-col justify-between items-center text-[11px] text-[#777778] p-3 ">
            ...
            <li>
              <Image src={StepsArrow} className="h-[40px] w-[40px] rotate-90" alt="" />
            </li>
            <li>Schedule call</li>
            <li>
              <Image src={StepsArrow} className="h-[40px] w-[40px] rotate-90" alt="" />
        ...
        <div className="w-[80%] h-full flex flex-col gap-5">
          <div className="bg-[#1b1c21] w-full h-[50%] p-5 flex justify-between border border-[#7777784d] hover:border-[#edd86e53] rounded-md relative overflow-hidden">
            <div className="flex flex-col justify-between">
              ...
              <button
                onClick={() =>
                  posthog.capture('pricing_plan_clicked', { plan: 'LeadsPad', price: 1200 })
                }
                className="w-[150px] border border-[#edd86e53] hover:bg-[#edd86e] hover:text-[#000] text-[#bfbfbf] text-[13px] font-bold px-5 py-2 rounded-md transition-all"
              >
                Get started
              </button>
            </div>
            ...
            <div className="flex flex-col justify-between">
              <div>
                <div className="mb-6">
                  ...
                  <p className="text-[#ffffff88] text-[14px] pr-5 leading-4">
                    Build from idea to a functional MVP ready to serve your customers.
                  </p>
                </div>
              ...
              <button
                onClick={() =>
                  posthog.capture('pricing_plan_clicked', { plan: 'LaunchPad', price: 3500 })
                }
                className="w-[150px] bg-[#edd86e] hover:bg-transparent border border-[#edd86e53] hover:text-[#bfbfbf] text-[#000] text-[13px] font-bold px-5 py-2 rounded-md transition-all"
              >
                Get started
              </button>
            </div>
