...
7. **Action close** — Write 4–6 specific, numbered action steps. No vague advice.
8. **Bio anchor** — One-sentence positioning line. Format: *"Clinton James is a GTM Engineer who helps [ICP] [outcome]. If [problem], [CTA]."*
9. **Quality check** — Run through the checklist below.
10. **Save** — `content/blog/YYYY-MM-DD-slug.md`
